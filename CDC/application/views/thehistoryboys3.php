<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption font-dark">
            ...
            <span class="caption-subject bold uppercase">รายชื่อเด็กทั้งหมด</span>
        </div>
        <div class="tools"></div>
    </div>
            ...
            <div class="page-toolbar">
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                        ...
                        <li>
                            <a href="<?= base_url(); ?>Main/thehistoryboys3_studentroom5">
                                <i class="i"></i> ห้อง 5</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <table class="table table-striped table-bordered table-hover" id="sample_1">
                ...
                foreach ($thehistoryboys3 as $r) { ?>
                    <tr>
                        ...
                        <td>
                            <center>
                                <form action="<?= base_url(); ?>main/editroom/<?php echo $r['id'] ?>"
                                      method="post">
                        ...
                        <td>
                            <center><a class="ask-plain"
                                       href="<?= base_url() ?>main/delstudent/<?php echo $r['id'] ?>">
