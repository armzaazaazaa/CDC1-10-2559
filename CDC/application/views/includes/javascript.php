...
<![endif]-->
 <!-- BEGIN CORE PLUGINS -->
        ...
        <script src="<?= base_url(); ?>assets/pages/scripts/components-bootstrap-touchspin.min.js" type="text/javascript"></script>
        <script src="<?= base_url(); ?>assets/jasny-bootstrap/js/jasny-bootstrap.min.js" type="text/javascript"></script>
        <script src="<?= base_url(); ?>assets/jasny-bootstrap/js/jasny-bootstrap.js" type="text/javascript"></script>
